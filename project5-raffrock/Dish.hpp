...
/**
* Struct representing an ingredient, outside of the dish class.
*/
struct Ingredient {
    std::string name;
    ...
    // Constructors
    Ingredient() : name(""), quantity(0), required_quantity(0), price(0.0) {};
    Ingredient(const std::string& name, int quantity, int required_quantity, double price) : name(name), quantity(quantity), required_quantity(required_quantity), price(price) {};
};
