...
* Rafael Chetata
* 12/02/24
* Updated file to use queue to store Dish pointers and vector for backup ingredients. I outlined functions to add, remove, and "prepare" objects from these datatypes. 
*/
...
public:
    ...
    */
    void setBackupIngredients(std::vector<Ingredient> backup_ingredients);
...
/**
    ...
    * @post: All dishes are processed, and detailed information is displayed
    ...
    PREPARING DISH: dish_name
    station_name  attempting to prepare dish_name...
    station_name: Insufficient ingredients. Replenishing ingredients...
    station_name: Ingredients replenished.
    station_name: Successfully prepared dish_name.

    Unable to replenish ingredients. Failed to prepare dish_name.

    station_name attempting to prepare dish_name...
    station_name: Dish not available. Moving to next station...
    */
